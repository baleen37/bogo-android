...
import com.crewbi.bogu.presenter.activity.NotificationTunnelActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(title: String, content: String?, url: String?) {
        val intent = Intent(this, NotificationTunnelActivity::class.java)
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_SINGLE_TOP)
        intent.putExtra(NotificationTunnelActivity.EXTRA.url, url)
